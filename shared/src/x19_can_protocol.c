...
x19_status_t x19_can_unpack_nav_telemetry(const uint8_t *buffer, size_t len, x19_nav_telemetry_t *nav) {
    if (!buffer || !nav) return X19_ERR_INVALID_ARG;
    if (len < sizeof(x19_nav_telemetry_t)) return X19_ERR_INVALID_ARG;
...
x19_status_t x19_can_unpack_env_telemetry(const uint8_t *buffer, size_t len, x19_env_telemetry_t *env) {
    if (!buffer || !env) return X19_ERR_INVALID_ARG;
    if (len < sizeof(x19_env_telemetry_t)) return X19_ERR_INVALID_ARG;
...
x19_status_t x19_can_unpack_power_telemetry(const uint8_t *buffer, size_t len, x19_power_telemetry_t *power) {
    if (!buffer || !power) return X19_ERR_INVALID_ARG;
    if (len < sizeof(x19_power_telemetry_t)) return X19_ERR_INVALID_ARG;
