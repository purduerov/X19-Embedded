 ...
 */
          ...
          STM32F439xx || STM32F401xC || STM32F401xE || STM32F411xE || STM32F469xx || STM32F479xx */
 ...
 */
#endif /* STM32F405xx || STM32F415xx || STM32F407xx || STM32F417xx || STM32F427xx || STM32F437xx || STM32F429xx ||     \
          STM32F439xx || STM32F401xC || STM32F401xE || STM32F411xE || STM32F446xx || STM32F469xx || STM32F479xx ||                             \
          STM32F412Zx || STM32F412Vx || STM32F412Rx || STM32F413xx | STM32F423xx */
...
#define IS_RCC_PLLSAI_DIVR_VALUE(VALUE)                                                                                \
    (((VALUE) == RCC_PLLSAIDIVR_2) || ((VALUE) == RCC_PLLSAIDIVR_4) || ((VALUE) == RCC_PLLSAIDIVR_8) ||                \
...
#endif /* STM32F411xE || STM32F446xx || STM32F412Zx || STM32F412Vx || STM32F412Rx || STM32F412Cx || STM32F413xx ||     \
          STM32F423xx  */
...
#define IS_RCC_PLLI2SP_VALUE(VALUE)                                                                                    \
    (((VALUE) == RCC_PLLI2SP_DIV2) || ((VALUE) == RCC_PLLI2SP_DIV4) || ((VALUE) == RCC_PLLI2SP_DIV6) ||                \
     ((VALUE) == RCC_PLLI2SP_DIV8))

#define IS_RCC_PLLSAIM_VALUE(VALUE) ((VALUE) <= 63U)

#define IS_RCC_PLLSAIP_VALUE(VALUE)                                                                                    \
    (((VALUE) == RCC_PLLSAIP_DIV2) || ((VALUE) == RCC_PLLSAIP_DIV4) || ((VALUE) == RCC_PLLSAIP_DIV6) ||                \
...
#define IS_RCC_SDIOCLKSOURCE(SOURCE) (((SOURCE) == RCC_SDIOCLKSOURCE_CLK48) || ((SOURCE) == RCC_SDIOCLKSOURCE_SYSCLK))
...
#define IS_RCC_DFSDM1AUDIOCLKSOURCE(__SOURCE__)                                                                        \
    (((__SOURCE__) == RCC_DFSDM1AUDIOCLKSOURCE_I2S1) || ((__SOURCE__) == RCC_DFSDM1AUDIOCLKSOURCE_I2S2))
...
#define IS_RCC_DFSDM2AUDIOCLKSOURCE(__SOURCE__)                                                                        \
    (((__SOURCE__) == RCC_DFSDM2AUDIOCLKSOURCE_I2S1) || ((__SOURCE__) == RCC_DFSDM2AUDIOCLKSOURCE_I2S2))
...
#if defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx)
#define IS_RCC_MCO2SOURCE(SOURCE)                                                                                      \
    (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) || ((SOURCE) == RCC_MCO2SOURCE_I2SCLK) || ((SOURCE) == RCC_MCO2SOURCE_HSE) || \
