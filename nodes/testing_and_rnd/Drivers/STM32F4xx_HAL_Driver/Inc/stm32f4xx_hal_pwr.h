...
#define IS_PWR_SLEEP_ENTRY(ENTRY)                                                                                      \
    (((ENTRY) == PWR_SLEEPENTRY_WFI) || ((ENTRY) == PWR_SLEEPENTRY_WFE) || ((ENTRY) == PWR_SLEEPENTRY_WFE_NO_EVT_CLEAR))

#define IS_PWR_STOP_ENTRY(ENTRY)                                                                                       \
    (((ENTRY) == PWR_STOPENTRY_WFI) || ((ENTRY) == PWR_STOPENTRY_WFE) || ((ENTRY) == PWR_STOPENTRY_WFE_NO_EVT_CLEAR))
/**
 * @}
 */
