 ...
 *            @arg @ref RCC_RTCCLKSOURCE_HSE_DIVX HSE divided by X selected as RTC clock (X can be retrieved thanks to
 * @ref __HAL_RCC_GET_RTC_HSE_PRESCALER()
 ...
 *            @arg RCC_MCO2SOURCE_PLLI2SCLK: PLLI2S clock selected as MCO2 source, available for all STM32F4 devices
 * except STM32F410xx
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                                                                   \
    (((((((__FLAG__) >> 5U) == 1U)                                                                                     \
            ? RCC->CR                                                                                                  \
            : ((((__FLAG__) >> 5U) == 2U) ? RCC->BDCR : ((((__FLAG__) >> 5U) == 3U) ? RCC->CSR : RCC->CIR))) &         \
...
#define IS_RCC_MCO1SOURCE(SOURCE)                                                                                      \
    (((SOURCE) == RCC_MCO1SOURCE_HSI) || ((SOURCE) == RCC_MCO1SOURCE_LSE) || ((SOURCE) == RCC_MCO1SOURCE_HSE) ||       \
     ((SOURCE) == RCC_MCO1SOURCE_PLLCLK))

#define IS_RCC_MCODIV(DIV)                                                                                             \
    (((DIV) == RCC_MCODIV_1) || ((DIV) == RCC_MCODIV_2) || ((DIV) == RCC_MCODIV_3) || ((DIV) == RCC_MCODIV_4) ||       \
     ((DIV) == RCC_MCODIV_5))
