...
static rov_status_t bme280_check_id(bme280_dev_t *dev) {
    ...
    rov_status_t status =
        bsp_i2c_mem_read(dev->i2c_addr, BME280_REG_CHIP_ID, &id, 1);
...
static rov_status_t bme280_read_calibration(bme280_dev_t *dev) {
     ...
     */
    dev->calib.dig_H4 =
        (int16_t)(((int16_t)(int8_t)calib2[3] << 4) |
                  (calib2[4] & 0x0Fu));

    dev->calib.dig_H5 =
        (int16_t)(((int16_t)(int8_t)calib2[5] << 4) |
                  (calib2[4] >> 4));
 ...
 */
static int32_t bme280_compensate_temperature(
    bme280_dev_t *dev,
    int32_t adc_t
) {
    int32_t var1;
...
static uint32_t bme280_compensate_pressure(
    ...
    var1 =
        ((var1 *
          var1 *
          (int64_t)dev->calib.dig_P3) >>
         8) +
        ((var1 *
          (int64_t)dev->calib.dig_P2) <<
         12);
...
/*
 * Bosch integer humidity compensation algorithm.
 *
 * Returns humidity in Q22.10 format.
 */
static uint32_t bme280_compensate_humidity(
    ...
    /*
     * Clamp humidity to the range supported by Bosch's
