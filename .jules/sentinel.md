...
## 2024-05-24 - CAN Payload Truncation vulnerability
**Vulnerability:** Silent truncation of CAN FD payloads into standard 8-byte frames.
**Learning:** Returning modified payload lengths or silently cutting off buffers hides errors from the caller which can lead to unexpected behavior or partial/corrupted packets being transmitted.
**Prevention:** Explicitly validate bounds and return error codes/booleans when lengths exceed hardware limits rather than implicitly truncating.
